...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'class_name' => '分類名',
        // 国
        'country_code' => '国コード(alpha-2)',
        'country_name_j' => '国名(日本語)',
        'country_name_e' => '国名(英語)',
        'country_code_a3' => '国コード(alpha-3)',
        'country_code_n3' => '国コード(numeric-3)',
        // 和暦
        'japanese_date' => '和暦',
        // 番号範囲
        'number_range' => '番号範囲オブジェクト',
        'number_from' => '開始番号',
        'number_to' => '終了番号',
        'current_number' => '現番号',
        // 税率
