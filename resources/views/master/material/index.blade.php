        ...
        <table class="ztable border-separate border border-gray-400">
            <thead class="text-center">
                <tr>
                    ...
                    <th class="p-2 border border-gray-300">{{__('color')}}</th>
                    <th class="p-2 border border-gray-300">{{__('engine')}}</th>
                    <th class="p-2 border border-gray-300">{{__('unit_amount')}}</th>
                    <th class="p-2 border border-gray-300">{{__('sikr_amount')}}</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="p-2 border border-gray-300">{{$material->color}}</td>
                    <td class="p-2 border border-gray-300 text-right">{{number_format($material->engine)}}</td>
                    <td class="p-2 border border-gray-300 text-right">{{number_format($material->unit_amount,0)}}</td>
                    <td class="p-2 border border-gray-300 text-right">{{number_format($material->sikr_amount,0)}}</td>
                    <td class="p-2 border border-gray-300 text-right">{{number_format($material->base_amount,0)}}</td>
